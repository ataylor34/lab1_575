/* Leaflet Proportional Symbols Example  with edits by ATaylor 3/2020 */
...
function Popup(properties, attribute, layer, radius){
    ...
    this.content = "<p><b>City:</b> " + this.properties.City + "</p><p><b>Percentage of Women in Parliament " + this.year + ":</b> " + this.percentage + " %</p>";
...
function pointToLayer(feature, latlng, attributes){
    ...
    panelContent += "<p><b>Percentage of Women in Parliament " + year + ":</b> " + feature.properties[attribute] + " %</p>";
    ...
    var LegendControl = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            for (var circle in circles){
                //circle string
                svg += '<circle class="legend-circle" id="' + circle + '" fill="#ff926a" fill-opacity="0.8" stroke="#000000" cx="30"/>';
...
function updateLegend(map, attribute){
    ...
    var year = attribute.split("_")[1];
    var content = "Women in Parliament in " + year;
